...
Для включения режима расширенных подсказок, воспользуйтесь сочетанием клавиш `F3` + `H`. Подробнее про про данные режимы можно прочитать в гугле или [wiki](//minecraft-ru.gamepedia.com/Экран_отладки).
